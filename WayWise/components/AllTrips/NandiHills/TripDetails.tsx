  ...
  return (
    <View>
      <View style={styles.header}>
        <Text style={styles.title}>Nandi Hills</Text>
      ...
      <Text style={styles.description}>
        Nandi Hills is a scenic hill station near Bengaluru, known for its
cool climate, misty sunrises, and panoramic views. It’s a favourite
spot for early morning drives and nature lovers.
      </Text>
    </View>
  );
};
