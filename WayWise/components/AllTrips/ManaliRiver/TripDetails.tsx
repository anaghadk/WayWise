  ...
  return (
    <View>
      <View style={styles.header}>
        <Text style={styles.title}>Beas River</Text>
      ...
      <Text style={styles.description}>
        Beas River flows through the picturesque valleys of Manali, known for its
clear waters and adventure sports. It's a popular spot for
rafting, picnics, and scenic views.
      </Text>
    </View>
  );
};
