  ...
  return (
    <View>
      <View style={styles.header}>
        <Text style={styles.title}>Skandagiri</Text>
      ...
      <Text style={styles.description}>
        Skandagiri is a popular trekking destination near Bengaluru, famous for
its night treks and sunrise views above the clouds. The trail offers a
moderate challenge with rewarding vistas.
      </Text>
    </View>
  );
};
