  ...
  return (
    <View>
      <View style={styles.header}>
        <Text style={styles.title}>Banerghatta National {'\n'}Park</Text>
      ...
      <Text style={styles.description}>
        Bannerghatta National Park is a vast wildlife reserve near Bengaluru,
home to a zoo, safari park, and butterfly enclosure. It’s ideal for
family outings and wildlife enthusiasts.
      </Text>
    </View>
  );
};
