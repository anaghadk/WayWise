  ...
  return (
    <View>
      <View style={styles.header}>
        <Text style={styles.title}>Ulsoor Lake</Text>
      ...
      <Text style={styles.description}>
        Ulsoor Lake is a serene getaway in the heart of Bengaluru, known for its
        calm waters, boating, and green surroundings. It's a popular spot for
        relaxing walks and scenic views.
      </Text>
    </View>
  );
};
